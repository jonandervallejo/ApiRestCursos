 ...
 */
final class Version20241010080212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE asignaturas ADD id_curso_id INT NOT NULL, ADD curso_id INT DEFAULT NULL, CHANGE horas horas VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_6740636A87CB4A1F ON asignaturas (curso_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6740636A87CB4A1F ON asignaturas');
        $this->addSql('ALTER TABLE asignaturas DROP id_curso_id, DROP curso_id, CHANGE horas horas INT DEFAULT NULL');
    }
}
